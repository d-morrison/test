...
```{r}
units::set_units(50, kg) * formattable::percent(.3)
formattable::percent(.3) * units::set_units(50, kg) 

units::set_units(50, kg/mL) * units::set_units(33, milliliter)
```
